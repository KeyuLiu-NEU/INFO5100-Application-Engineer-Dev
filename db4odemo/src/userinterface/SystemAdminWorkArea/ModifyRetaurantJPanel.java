 ...
 * @author Keyu Liu
 */
public class ModifyRetaurantJPanel extends javax.swing.JPanel {
     ...
     */
    public ModifyRetaurantJPanel(JPanel userProcessContainer,UserAccount account, EcoSystem system) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        system.getUserAccountDirectory().createUserAccount(txtName.getText(), txtPassword.getText(), employee, new AdminRole());
