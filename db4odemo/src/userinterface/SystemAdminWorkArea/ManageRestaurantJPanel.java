...
public class ManageRestaurantJPanel extends javax.swing.JPanel {
    ...
    private void populateRestaurantTable() {
        ...
        for(UserAccount ua : system.getUserAccountDirectory().getUserAccountList()){
            if(ua.getRole().toString().equals("Business.Role.RestaurantAdmin")){
    ...
    private void modifyJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modifyJButtonActionPerformed
        ...
        if(selectedRow < 0){
            ...
            ModifyRetaurantJPanel panel = new ModifyRetaurantJPanel(userProcessContainer, ua, system);
            userProcessContainer.add("ModifyRetaurantJPanel", panel);
            CardLayout layout = (CardLayout) userProcessContainer.getLayout();
