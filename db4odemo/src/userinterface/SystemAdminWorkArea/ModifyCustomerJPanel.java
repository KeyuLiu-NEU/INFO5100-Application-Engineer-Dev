...
public class ModifyCustomerJPanel extends javax.swing.JPanel {
     ...
     */
    public ModifyCustomerJPanel(JPanel userProcessContainer,UserAccount account, EcoSystem system) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        system.getUserAccountDirectory().createUserAccount(txtName.getText(), txtPassword.getText(), employee, new CustomerRole());
