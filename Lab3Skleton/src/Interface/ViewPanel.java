...
public class ViewPanel extends javax.swing.JPanel {
    ...
    ViewPanel(JPanel userProcessContainer, Product prod, ProductDirectory accDir) {
        initComponents();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        // TODO add your handling code here:
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Please type in an integer for number.");
                return;
            }
            
            if (txtProdName.getText() == null || txtProdName.getText().equals("")){
            JOptionPane.showMessageDialog(null, "You should enter one Name", "Warning",JOptionPane.WARNING_MESSAGE);
            return;
        }
            if (txtDesc.getText() == null || txtDesc.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Description can't be empty!", "Warning",JOptionPane.WARNING_MESSAGE);
            return;
        }
