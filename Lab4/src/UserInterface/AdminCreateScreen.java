...
public class AdminCreateScreen extends javax.swing.JPanel {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(!passwordPatternCorrect()){
            ...
            JOptionPane.showMessageDialog(null, "Password should be at least 6 digits and a"
                                                + "combination of number, upper case, lower case and"
                                                + "special charactors $, *, # or &");
            return;
        }
        if(!p1.equals(p2)){
        ...
        if(radioCustomer.isSelected()){
            ...
            admin.getCustDir().getCustomerList().add(new Customer(p1, username, createdOn));          
